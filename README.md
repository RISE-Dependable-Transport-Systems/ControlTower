...
A ground control station based on [WayWise](https://github.com/das-rise/WayWise) and [MAVSDK](http://mavsdk.io/) that can control [PX4](https://px4.io/)-based drones and [WayWise](https://github.com/das-rise/WayWise)-based vehicles via MAVLINK.
...
MAVSDK 2.0 is required (support for version 3.0 is not yet available). Pre-built releases can be found at https://github.com/mavlink/MAVSDK/releases. To instead build MAVSDK from source, simple [scripts can be found in the WayWise repository](https://github.com/das-rise/WayWise/tree/main/tools/build_MAVSDK).
...
See: [doc/Building-for-Windows.md](https://github.com/das-rise/ControlTower/blob/main/doc/Building-for-Windows.md)
